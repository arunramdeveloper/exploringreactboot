        ...
        <div style={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
          ...
          >
            <div className="d-flex justify-content-between align-items-center">
              ...
              <nav>
                <ul className="nav">
                  {['Home', 'Service', 'Product', 'Settings', 'About', 'Contact', 'Logout'].map((item, index) => (
          ...
          >
            ...
            <p style={{ color: '#333', lineHeight: '1.6' }}>
              This is the content area. Feel free to add your main content here. The header and footer are styled with modern
              colors and gradients to create a professional, sleek look.
            </p>
          </main>
